...
const hubs = [
  {
    ...
    stats: [
      ...
      {
        v: batchGroups.reduce((s, b) => s + b.members, 0).toLocaleString(),
        l: "Members",
      },
    ],
  ...
  },
  {
    ...
    stats: [
      ...
      {
        v: deptGroups.reduce((s, g) => s + g.members, 0).toLocaleString(),
        l: "Members",
      },
    ],
    stripe: "bg-blue-600",
    ...
    <>
      ...
      <div className="bg-forest-950 pt-24 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <span className="font-mono text-[10px] tracking-[0.5em] uppercase text-forest-500 whitespace-nowrap">
              MISTAS
            </span>
            <div className="flex-1 border-t border-forest-800" />
            <span className="font-mono text-[10px] tracking-[0.5em] uppercase text-forest-400 whitespace-nowrap">
              Community Hub
            </span>
            <div className="flex-1 border-t border-forest-800" />
            <span className="font-mono text-[10px] tracking-[0.5em] uppercase text-forest-500 whitespace-nowrap">
            ...
            >
              <div className="border-l-2 border-forest-600 pl-6">
                <p className="font-body text-forest-300 text-lg leading-relaxed mb-8">
                  From batch mates to global chapters, department networks to
                  open discussions — find and connect with your MIST community.
                </p>
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={l} className="border border-forest-700 px-4 py-3">
                      ...
                      <div className="font-mono text-[9px] text-forest-500 tracking-widest uppercase mt-0.5">
                        {l}
                      </div>
                    </div>
                  ))}
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="relative flex items-stretch gap-0" ref={searchRef}>
                  ...
                  >
                    ...
                    {filterOptions.map((opt) => (
                      ...
                      >
                        ...
                        />
                        <span
                          className={`font-sans text-sm ${filter === opt.value ? "font-semibold text-forest-900" : "text-forest-700"}`}
                        >
                          {opt.label}
                        </span>
                        {filter === opt.value && (
                          <span className="ml-auto font-mono text-[9px] text-forest-400 tracking-widest uppercase">
                            ✓
                          </span>
                        )}
                      </button>
            ...
            <div className="flex-1 relative">
              <Search
                size={15}
                className="absolute left-4 top-1/2 -translate-y-1/2 text-forest-400 pointer-events-none"
              />
              <input
                value={query}
                ...
                >
                  {filteredResults.length === 0 ? (
                    <div className="px-6 py-10 text-center">
                      <Search
                        size={22}
                        className="text-forest-200 mx-auto mb-3"
                      />
                    ...
                    <>
                          ...
                          return (
                            <div key={type}>
                              ...
                              <div className="px-5 py-2 bg-forest-50/60 flex items-center gap-2">
                                ...
                                <span className="font-mono text-[9px] text-forest-400 ml-1">
                                  ({items.length})
                                </span>
                              </div>
                              ...
                              {items.map((result, ri) => (
                                ...
                                >
                                  {/* Type badge */}
                                  <span
                                    className={`font-mono text-[9px] tracking-widest uppercase px-2 py-1 flex-shrink-0 ${meta.bg} ${meta.text}`}
                                  >
                                    {type === "batch"
                                      ? "BATCH"
                                      : type === "dept"
                                  ...
                                  <ChevronRight
                                    size={13}
                                    className="text-forest-200 group-hover:text-forest-500 transition-colors flex-shrink-0"
                                  />
                                </Link>
                              ))}
                            </div>
                      ...
                      <div className="px-5 py-3 border-t border-forest-100 bg-forest-50/40 flex items-center justify-between">
                        <span className="font-mono text-[9px] tracking-widest uppercase text-forest-400">
                          Press{" "}
                          <kbd className="bg-white border border-forest-200 px-1.5 py-0.5 text-forest-600 font-sans">
                            Esc
                          </kbd>{" "}
                          to close
                        </span>
          ...
          <div className="flex items-center gap-2 mt-3 flex-wrap">
            <span className="font-mono text-[9px] tracking-widest uppercase text-forest-300 mr-1">
              Quick:
            </span>
            {[
      ...
      {/* ── 4 Hub Cards ───────────────────────────────────────────── */}
      <section className="py-20 bg-gradient-to-br from-white via-white to-forest-50/30 relative overflow-hidden">
        {/* Animated background elements */}
        <motion.div
          className="absolute -top-40 -right-40 w-80 h-80 bg-forest-100 rounded-full blur-3xl opacity-20 pointer-events-none"
          animate={{ x: [0, 30, -15], y: [0, -30, 15] }}
          transition={{ duration: 8, repeat: Infinity, repeatType: "reverse" }}
        />
        <motion.div
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-blue-100 rounded-full blur-3xl opacity-20 pointer-events-none"
          animate={{ x: [0, -30, 15], y: [0, 30, -15] }}
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex items-center gap-6 mb-14">
            ...
            <span className="font-mono text-[10px] tracking-[0.45em] uppercase text-forest-300">
              4 Spaces
            </span>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {hubs.map((hub, i) => (
              <MotionLink
                ...
                className="flex flex-col bg-white/70 group rounded-2xl border border-forest-100/60 overflow-hidden relative cursor-pointer backdrop-blur-xl transition-all duration-300"
              >
                {/* Gradient accent bar with animation */}
                <motion.div
                  className={`${hub.stripe} h-1 w-full`}
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${hub.stripe === "bg-forest-600" ? "rgba(5, 122, 85, 0.03)" : hub.stripe === "bg-blue-600" ? "rgba(37, 99, 235, 0.03)" : hub.stripe === "bg-amber-500" ? "rgba(217, 119, 6, 0.03)" : "rgba(109, 40, 217, 0.03)"}, transparent)`,
                  }}
                />

                {/* Large animated number background */}
                <motion.div
                  className={`absolute top-4 right-6 font-display font-bold text-[88px] leading-none select-none pointer-events-none ${hub.numColor} group-hover:opacity-[0.15] transition-opacity duration-500`}
                ...
                <div className="relative p-8 flex flex-col flex-1">
                  ...
                  <div className="flex items-center justify-between mb-8">
                    <motion.span
                      className={`font-mono text-[10px] tracking-[0.45em] uppercase ${hub.iconColor} opacity-70`}
                      animate={{ x: [0, 4, 0] }}
                      transition={{ duration: 3, repeat: Infinity }}
                    >
                      {hub.num}
                    ...
                    <motion.div
                      className={`w-14 h-14 flex items-center justify-center rounded-2xl border-2 ${hub.chipBorder} ${hub.chipBg} ${hub.iconColor} group-hover:scale-125 transition-transform duration-300 relative`}
                      animate={{ y: [0, -6, 0], rotate: [0, 3, 0] }}
                      transition={{ duration: 3, repeat: Infinity }}
                    >
                      {/* Glow effect */}
                      <motion.div
                        className={`absolute inset-0 rounded-2xl ${hub.stripe} blur-xl opacity-0 group-hover:opacity-40 transition-opacity duration-300`}
                      />
                      <div className="relative z-10">{hub.icon}</div>
                    </motion.div>
                  </div>

                  {/* Title */}
                  <h3 className="font-display text-[28px] font-bold text-forest-950 leading-tight mb-3 group-hover:text-forest-700 transition-colors">
                    {hub.label}
                  </h3>

                  {/* Description */}
                  <p className="font-sans text-sm text-forest-600 leading-relaxed mb-8 flex-1">
                    {hub.desc}
                  </p>

                  {/* Stats with glassmorphism */}
                  <div className="flex gap-3 mb-8">
                    {hub.stats.map(({ v, l }, idx) => (
                      <motion.div
                        key={l}
                        className={`flex-1 border-2 ${hub.chipBorder} ${hub.chipBg} px-4 py-3 text-center rounded-xl backdrop-blur-md bg-white/40 overflow-hidden relative group/stat`}
                        whileHover={{ y: -2 }}
                      >
                        {/* Shimmer effect on hover */}
                        <motion.div
                          className={`absolute inset-0 ${hub.stripe} opacity-0 group-hover/stat:opacity-10 transition-opacity`}
                          animate={{ x: ["-100%", "100%"] }}
                          transition={{ duration: 2, repeat: Infinity }}
                        />
                        <div className="relative z-10">
                          <motion.div
                            className={`font-display text-xl font-bold ${hub.chipText}`}
                            animate={{ y: [0, -2, 0] }}
                            transition={{
                              duration: 2,
                              delay: idx * 0.1,
                          ...
                          <div
                            className={`font-mono text-[9px] tracking-widest uppercase mt-0.5 ${hub.chipLabel}`}
                          >
                            {l}
                          </div>
                        </div>
                  ...
                  {/* Footer CTA */}
                  <div className="flex items-center justify-between pt-6 border-t border-forest-100/50">
                    <motion.span
                      className={`font-sans font-bold text-sm ${hub.ctaColor} transition-all flex items-center gap-2 group-hover:gap-3`}
                      animate={{ x: [0, 2, 0] }}
                      transition={{ duration: 3, repeat: Infinity }}
                    >
                    ...
                    <motion.div
                      className={`w-7 h-[2px] ${hub.stripe} scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-right`}
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <span className="font-mono text-[10px] tracking-[0.4em] uppercase text-forest-400">
                  Latest Batches
                </span>
                <div className="flex-1 border-t border-forest-100" />
                <Link
                  to="/community/batch"
                  className="text-xs font-bold text-forest-600 flex items-center gap-1 hover:gap-2 transition-all"
                >
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <span
                          className={`w-2 h-2 rounded-full ${b.status === "Active" ? "bg-emerald-400" : "bg-amber-400"}`}
                        />
                        <span className="font-display text-2xl font-bold text-forest-900">
                          {b.year}
                        </span>
                        <span className="font-mono text-[9px] text-forest-400 tracking-widest uppercase hidden sm:block">
                          {b.status}
                        </span>
                      </div>
                      <div className="flex items-center gap-6 text-xs text-forest-400">
                        ...
                        <ChevronRight
                          size={13}
                          className="text-forest-200 group-hover:text-forest-500 transition-colors"
                        />
                      </div>
                    </Link>
                  </motion.div>
              ...
              <div className="space-y-2">
                {forumTopics.map((t, i) => (
                  ...
                  >
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        <p className="font-sans text-sm font-medium text-forest-900 group-hover:text-forest-700 transition-colors leading-snug truncate">
                          {t.title}
                        </p>
                        <div className="flex items-center gap-3 mt-1">
                          <span className="font-mono text-[9px] text-forest-400 tracking-wider">
                            {t.category}
                          </span>
                      ...
                      <ChevronRight
                        size={13}
                        className="text-forest-200 group-hover:text-forest-500 transition-colors flex-shrink-0 mt-0.5"
                      />
                    </Link>
                  </motion.div>
                ))}
