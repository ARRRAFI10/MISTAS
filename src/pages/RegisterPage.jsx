...
const inputCls =
  "w-full border border-zinc-300 rounded-lg px-4 py-3 text-sm font-sans text-zinc-900 placeholder-zinc-400 focus:outline-none focus:border-forest-600 focus:ring-2 focus:ring-forest-100 transition-all bg-white";
const labelCls =
  "block text-xs font-semibold tracking-wide uppercase text-zinc-600 mb-1.5";
...
export default function RegisterPage() {
    ...
    return (
      <div className="min-h-screen bg-zinc-50 flex items-center justify-center px-6 py-24">
        ...
        >
          ...
          <h2 className="font-display text-4xl text-zinc-900 font-bold mb-4">
            Welcome to MISTAS!
          </h2>
          <p className="font-body text-zinc-600 leading-relaxed mb-4">
            Your registration is complete. Your account is under review and will
            be activated within 1–2 business days after verification.
          </p>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      {/* Header */}
      <div className="bg-forest-950 py-6 px-6 border-b border-forest-900">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-2xl mx-auto px-6 py-10 lg:py-16">
                      ...
                      <div
                        className={`w-9 h-9 rounded-full flex items-center justify-center border-2 transition-all duration-300 ${
                          isComplete
                            ...
                            : isCurrent
                              ? "bg-white border-forest-600 shadow-md shadow-forest-100"
                      ...
                      >
                        {isComplete ? (
                          ...
                          <Icon
                            size={15}
                            className={
                              isCurrent ? "text-forest-600" : "text-zinc-300"
                            }
                          />
                        )}
                      </div>
                      <span
                        className={`font-mono text-[9px] tracking-widest uppercase hidden sm:block whitespace-nowrap ${
                          isCurrent
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-sm text-zinc-500">
                    Your basic contact and account details.
                  </p>
                </div>
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 p-4 border-2 border-dashed border-zinc-200 rounded-xl hover:border-forest-400 transition-colors cursor-pointer bg-zinc-50 hover:bg-forest-50/50">
                      ...
                      <div>
                        <p className="font-sans text-sm font-semibold text-zinc-700">
            ...
            {step === 2 && (
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-sm text-zinc-500">
                    Your MIST background and current career information.
                  </p>
                </div>
                <div className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      className={inputCls}
                      placeholder="e.g. 200812345"
                    />
                  </div>
                  <div>
                    <label className={labelCls}>
                      Thesis / Project Title (optional)
                    </label>
                    <input
                      type="text"
                      className={inputCls}
                      placeholder="Your final year thesis title"
                    />
                  </div>
                  <div className="pt-4 border-t border-zinc-100">
                    <p className="font-semibold text-xs tracking-wide uppercase text-zinc-500 mb-4">
                      Current Career
                    </p>
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            type="text"
                            className={inputCls}
                            placeholder="e.g. Google, Bangladesh Army"
                          />
                        </div>
                      </div>
                      <div className="grid sm:grid-cols-2 gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <ul className="space-y-1.5">
                              {tier.features.map((f, i) => (
                                <li
                                  key={i}
                                  className="flex items-start gap-2 text-sm font-sans text-zinc-600"
                                >
                                  <CheckCircle
                                    size={13}
                                    className={`mt-0.5 flex-shrink-0 ${tier.id === "lifetime" ? "text-amber-500" : "text-forest-500"}`}
                                  />
                                  {f}
                                </li>
                              ))}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      >
                        <div className="font-sans font-bold text-sm text-zinc-800">
                          {method.label}
                        </div>
                        <div className="font-sans text-xs text-zinc-400 mt-1 leading-tight">
                          {method.desc}
                        </div>
                      </button>
                    ))}
            ...
            {step === 4 && (
              ...
              >
                  ...
                  {[
                    {
                      ...
                      value:
                        selectedTier === "lifetime"
                          ? "Lifetime Member — BDT 5,000 (one-time)"
                          : "Regular Member — BDT 500 / year",
                    },
                    {
                      label: "Account Activation",
                      value: "Within 1–2 business days after verification",
                    },
                    {
                      label: "Verification Method",
                      value: "MIST student ID or graduation certificate",
                    },
                  ].map(({ label, value }) => (
                    <div
                      key={label}
                      className="flex items-start gap-4 p-4 bg-zinc-50 rounded-xl border border-zinc-100"
                    >
                      <CheckCircle
                        size={16}
                      ...
                      />
                      <div>
                        <div className="font-sans text-xs font-semibold tracking-wide uppercase text-zinc-400 mb-0.5">
                          {label}
                        </div>
                        <div className="font-sans text-sm font-medium text-zinc-900">
                          {value}
                        </div>
                      </div>
                    </div>
                ...
                <div className="flex items-start gap-3 mb-6 p-4 border border-zinc-200 rounded-xl bg-zinc-50">
                  ...
                  <label
                    htmlFor="terms"
                    className="font-sans text-sm text-zinc-600 leading-relaxed cursor-pointer"
                  >
          ...
          <p className="text-center font-sans text-sm text-zinc-400 mt-6">
            Already registered?{" "}
            <Link
              to="/login"
