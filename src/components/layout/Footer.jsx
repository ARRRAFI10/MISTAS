...
import { GraduationCap, Mail, Phone, MapPin, Facebook, Linkedin, Youtube, Twitter } from 'lucide-react'
    ...
    <footer className="bg-forest-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="font-body text-sm text-forest-300 leading-relaxed mb-6">
              Connecting generations of MIST graduates across the globe. Building bridges between the past, present, and future of excellence.
            </p>
          ...
          {Object.entries(footerLinks).map(([section, links]) => (
            <div key={section}>
              <h4 className="font-mono text-xs tracking-widest uppercase text-forest-400 mb-4">{section}</h4>
        ...
        <div className="mt-14 pt-8 border-t border-forest-800 flex flex-wrap gap-6">
          {[
            ...
            <div key={i} className="flex items-center gap-2 text-sm font-sans text-forest-400">
      ...
      <div className="border-t border-forest-900 py-4">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row justify-between gap-2 text-xs font-mono text-forest-600">
          <span>© {new Date().getFullYear()} MISTAS — MIST Alumni Association. All rights reserved.</span>
          <div className="flex gap-5">
            <Link to="/privacy" className="hover:text-forest-400 transition-colors">Privacy Policy</Link>
            <Link to="/terms" className="hover:text-forest-400 transition-colors">Terms of Use</Link>
          </div>
        </div>
      </div>
    </footer>
