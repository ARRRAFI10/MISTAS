...
export default function StatsDashboard() {
  return (
    <section className="relative py-32 overflow-hidden border-y border-zinc-900 min-h-[80vh] flex items-center">
      ...
      */}
      <div className="absolute inset-0 bg-gradient-to-r from-green-950/85 via-green-900/35 to-transparent" />
      <div className="absolute inset-0 bg-gradient-to-t from-green-950/75 via-transparent to-transparent" />
        ...
        <div className="flex flex-col lg:flex-row gap-20">
          ...
          <div className="lg:w-1/3 flex flex-col justify-between">
            <div>
              ...
              >
                Impact <br />
                <span className="text-forest-400 italic font-serif font-light">
                  at scale.
                </span>
              </motion.h2>
              <motion.p
              ...
              >
                MISTAS isn't just an association; it's a growing global force.
                Our graduates are making their mark across industries,
          ...
          <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-16">
            ...
            >
              <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-zinc-950/70 backdrop-blur-md border border-white/10 font-mono text-xs tracking-[0.3em] text-white uppercase mb-8 shadow-xl">
                <Users size={16} className="text-forest-400" />
