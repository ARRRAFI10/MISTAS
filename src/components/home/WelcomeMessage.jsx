...
import { CornerDecor, Section } from "../ui";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative">
              ...
              >
                <div className="font-mono text-[9px] tracking-widest uppercase text-forest-400 mb-2">
                  Message from
                </div>
                <div className="font-display text-base font-semibold text-white mb-1">
                  President, MISTAS
                </div>
                <div className="font-sans text-xs text-forest-400">
                  Major General Md Hakimuzzaman, SGP, ndc, afwc, psc
                </div>
          ...
          <div>
            ...
            <motion.h2
              {...fadeUp(0.2)}
              className="font-display text-4xl text-forest-900 leading-snug mb-6"
            >
            ...
            <div className="space-y-4 font-body text-forest-700 leading-relaxed text-[15px]">
              <motion.p {...fadeUp(0.3)}>
                As you walk through the gates of MIST — whether for the first
                time as a student, or again as a returning graduate — you carry
                with you the mark of an institution that has shaped generations
                of leaders, engineers, and visionaries.
              </motion.p>
              <motion.p {...fadeUp(0.38)}>
                MISTAS was founded on a single belief: that the bonds forged in
                the corridors of MIST do not end at graduation. They grow
                stronger with time, distance, and shared purpose.
              </motion.p>
              <motion.p {...fadeUp(0.46)}>
                This platform is your home — a place to reconnect, contribute,
                mentor, and be inspired. We invite you to be an active part of
                this living, breathing community.
              </motion.p>
            </div>

            <motion.div
              {...fadeUp(0.55)}
              className="mt-8 pt-6 border-t border-forest-100 flex items-center gap-4"
            >
              <div>
                <div className="font-sans font-semibold text-sm text-forest-900">
                  Major General Md Hakimuzzaman, SGP, ndc, afwc, psc
                </div>
                <div className="font-mono text-xs text-forest-500 tracking-wide">
                  President, MISTAS • CE-02
                </div>
              </div>
            </motion.div>
          </div>
